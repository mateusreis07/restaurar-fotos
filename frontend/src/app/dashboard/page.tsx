        ...
        <footer className="w-full py-12 px-6 mt-auto bg-[#f0f3ff] border-t border-[#dce2f3]">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4 text-center md:text-left">
              <Link href="/" className="active:scale-95 transition-transform group inline-block">
                 <img src="/examples/logo-reviva-sem-fundo.png" alt="Reviva Logo" className="h-12 w-auto object-contain" title="Reviva" />
              </Link>
              <p className="font-body text-[14px] text-[#575f6a] font-medium tracking-wide">© 2026 Reviva. Suas memórias, lindamente preservadas.</p>
            </div>
