      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 md:px-16 lg:px-24">
        ...
        <div className="max-w-md w-full mx-auto lg:mx-0">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <label htmlFor="password" className="block text-sm font-bold text-slate-700">Sua Senha</label>
              <input
                id="password"
                type="password"
                placeholder="••••••••"
          ...
          <p className="text-slate-500 text-sm mt-8 text-center lg:text-left">
            Ainda não tem conta? <Link href="/signup" className="text-primary font-bold hover:underline">Cadastre-se aqui</Link>
          </p>
        </div>
      </div>
