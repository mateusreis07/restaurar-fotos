  ...
  return (
    <nav className="md:hidden fixed bottom-0 w-full bg-white/95 backdrop-blur-md border-t border-[#dce2f3] pt-3 pb-6 px-4 flex justify-around items-center z-50 shadow-[0_-10px_20px_rgba(0,0,0,0.02)]">
        <Link href="/dashboard" className={`flex flex-col items-center gap-1.5 w-full transition-colors ${isActive('/dashboard') ? 'text-[#483ede]' : 'text-[#a0abbb] hover:text-[#575f6a]'}`}>
            ...
            <span className={`text-[10px] uppercase tracking-widest ${isActive('/dashboard') ? 'font-extrabold' : 'font-bold'}`}>Galeria</span>
        </Link>
        <Link href="/upload" className={`flex flex-col items-center gap-1.5 w-full transition-colors ${isActive('/upload') ? 'text-[#483ede]' : 'text-[#a0abbb] hover:text-[#575f6a]'}`}>
            ...
            <span className={`text-[10px] uppercase tracking-widest ${isActive('/upload') ? 'font-extrabold' : 'font-bold'}`}>Restaurar</span>
        </Link>
        <Link href="/pricing" className={`flex flex-col items-center gap-1.5 w-full transition-colors ${isActive('/pricing') ? 'text-[#483ede]' : 'text-[#a0abbb] hover:text-[#575f6a]'}`}>
            ...
            <span className={`text-[10px] uppercase tracking-widest ${isActive('/pricing') ? 'font-extrabold' : 'font-bold'}`}>Créditos</span>
        </Link>
        <button 
          onClick={() => { 
