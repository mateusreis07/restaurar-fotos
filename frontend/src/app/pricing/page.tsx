        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center max-w-[1100px] mx-auto">
          ...
          <div className="bg-[#f0f3ff] p-10 rounded-[2rem] shadow-sm space-y-8 flex flex-col border border-[#dce2f3] hover:-translate-y-1 transition-transform cursor-default">
            <div className="space-y-2">
              <h3 className="font-headline font-bold text-[22px] text-[#151c27]">Iniciante</h3>
              <div className="flex items-baseline space-x-1.5">
                <span className="text-[20px] font-bold text-[#575f6a]">R$</span>
                <span className="text-[48px] font-extrabold text-[#151c27] tracking-tighter">29</span>
              </div>
            </div>
            <ul className="space-y-4 flex-grow">
              <li className="flex items-center space-x-3 text-[#575f6a]">
                ...
                <span className="font-bold text-[#151c27] text-[15.5px]">5 fotos restauradas</span>
              </li>
              <li className="flex items-center space-x-3 text-[#575f6a]">
                <span className="material-symbols-outlined text-[#0f6b40]">check_circle</span>
                <span className="text-[15px] font-medium">Alta definição (HD)</span>
              </li>
              <li className="flex items-center space-x-3 text-[#575f6a]">
                <span className="material-symbols-outlined text-[#0f6b40]">check_circle</span>
                <span className="text-[15px] font-medium">Sem expiração de crédito</span>
              </li>
            </ul>
            <button 
              onClick={() => handleBuyCredits('price_5')}
            ...
            >
              {loadingPlan === 'price_5' ? <span className="material-symbols-outlined animate-spin text-[20px]">refresh</span> : 'Adquirir Pacote'}
            </button>
          </div>
          ...
          <div className="bg-white p-10 py-12 md:scale-105 rounded-[2rem] shadow-[0_30px_60px_rgba(0,0,0,0.1)] ring-[3px] ring-[#483ede] relative space-y-8 flex flex-col z-10 mx-auto w-full border border-white">
            ...
            <div className="space-y-2">
              <h3 className="font-headline font-extrabold text-[24px] text-[#483ede]">Baú da Família</h3>
              <div className="flex items-baseline space-x-1.5 text-[#483ede]">
                <span className="text-[24px] font-extrabold">R$</span>
                <span className="text-[60px] font-black tracking-tighter">49</span>
              </div>
            </div>
            <ul className="space-y-5 flex-grow">
              <li className="flex items-center space-x-3">
                <span className="material-symbols-outlined text-[#483ede] font-bold">verified</span>
                <span className="font-extrabold text-[#151c27] text-[16.5px]">10 fotos restauradas</span>
              </li>
              <li className="flex items-center space-x-3 text-[#575f6a]">
                <span className="material-symbols-outlined text-[#483ede] font-bold">verified</span>
                <span className="text-[15px] font-bold text-[#151c27]">Restauração facial avançada</span>
              </li>
              <li className="flex items-center space-x-3 text-[#575f6a]">
                <span className="material-symbols-outlined text-[#483ede] font-bold">verified</span>
                <span className="text-[15px] font-medium">Acesso imediato Aura Ultra 4K</span>
              </li>
              <li className="flex items-center space-x-3 text-[#575f6a]">
                <span className="material-symbols-outlined text-[#483ede] font-bold">verified</span>
                <span className="text-[15px] font-medium">Tratamento de Cores IA Avançado</span>
              </li>
            </ul>
            <button 
            ...
            >
              {loadingPlan === 'price_10' ? <span className="material-symbols-outlined animate-spin text-[24px]">refresh</span> : 'Quero este pacote'}
            </button>
          </div>
          ...
          <div className="bg-[#f0f3ff] p-10 rounded-[2rem] shadow-sm space-y-8 flex flex-col border border-[#dce2f3] hover:-translate-y-1 transition-transform cursor-default">
            <div className="space-y-2">
              <h3 className="font-headline font-bold text-[22px] text-[#151c27]">Legado Completo</h3>
              <div className="flex items-baseline space-x-1.5">
                <span className="text-[20px] font-bold text-[#575f6a]">R$</span>
                <span className="text-[48px] font-extrabold text-[#151c27] tracking-tighter">79</span>
              </div>
            </div>
            <ul className="space-y-4 flex-grow">
              <li className="flex items-center space-x-3 text-[#575f6a]">
                <span className="material-symbols-outlined text-[#0f6b40]">check_circle</span>
                <span className="font-bold text-[#151c27] text-[15.5px]">20 fotos restauradas</span>
              </li>
              <li className="flex items-center space-x-3 text-[#575f6a]">
                <span className="material-symbols-outlined text-[#0f6b40]">check_circle</span>
                <span className="text-[15px] font-medium">Apenas R$ 3,95 / foto salva</span>
              </li>
              <li className="flex items-center space-x-3 text-[#575f6a]">
                <span className="material-symbols-outlined text-[#0f6b40]">check_circle</span>
                <span className="text-[15px] font-medium">Prioridade na Fila IA (Rápido)</span>
              </li>
            </ul>
            <button 
              onClick={() => handleBuyCredits('price_20')}
              disabled={loadingPlan !== null}
              className="w-full py-4 rounded-[1.25rem] border-2 border-[#483ede] text-[#483ede] font-extrabold tracking-wide hover:bg-[#483ede]/5 active:scale-95 transition-all flex items-center justify-center gap-2"
            >
              {loadingPlan === 'price_20' ? <span className="material-symbols-outlined animate-spin text-[20px]">refresh</span> : 'Adquirir Pacote'}
            </button>
          </div>
